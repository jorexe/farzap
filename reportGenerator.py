...
parser = argparse.ArgumentParser(description="Generates random report from ZAP")
parser.add_argument('-o', '--out', default='generated.xml')
parser.add_argument('-n', '--alertcount', default=40, type=int)
